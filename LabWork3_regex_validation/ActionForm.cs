...
{    
    public partial class ActionForm : Form
    {
        ...
        private void HideShowTools_Click(object sender, EventArgs e)
        {
        ...
        private void FindByLecturerTool_DoubleClick(object sender, EventArgs e)
        {
            OutFindInf.Text = "";
            foreach (var el in from n in discplineList where n.lecturer.nameLecturer == FindByLecturerTool.Text select n.lecturer)
            {
                OutFindInf.Text += "Имя лектора-" + el.nameLecturer + "\r\n" +
                    "Кабинет-" + el.office + "\r\n" +
                    "Кафедра-" + el.departament +
        ...
        private void SortByCoursTool_Click(object sender, EventArgs e)
        {
            ByCourse_Click(sender, e);
        }

        private void toolStripByCoursTextBox_DoubleClick_1(object sender, EventArgs e)
        {
            OutFindInf.Text = "";
            foreach (var el in from n in discplineList where n.course.ToString() == toolStripByCoursTextBox.Text select n.lecturer)
            {
                OutFindInf.Text += "Имя лектора-" + el.nameLecturer + "\r\n" +
                    "Кабинет-" + el.office + "\r\n" +
                    "Кафедра-" + el.departament +
            ...
            toolStripByCoursTextBox.Text = "";
        }

        private void toolStripBySemestrTextBox_DoubleClick_1(object sender, EventArgs e)
        {
            OutFindInf.Text = "";
            foreach (var el in from n in discplineList where n.semester.ToString() == toolStripBySemestrTextBox.Text select n.lecturer)
            {
                OutFindInf.Text += "Имя лектора-" + el.nameLecturer + "\r\n" +
                    "Кабинет-" + el.office + "\r\n" +
                    "Кафедра-" + el.departament +
            ...
            toolStripBySemestrTextBox.Text = "";
        }

        private void FindedLector_Click(object sender, EventArgs e)
        {
